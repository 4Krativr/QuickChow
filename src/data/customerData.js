export const customerReview = [
    {
        ...
        profilePic: '../assets/Ellipse 9.png',
        review:  `"QuickChow is the best. I’m honestly blown away by the speed and reliability of this food delivery service! My order arrived well before the estimated time, and everything was still fresh and hot. The app was super easy to use, and I appreciated the real-time tracking feature, so I knew exactly when to expect my food."`,
        starRating: '../assets/stars-ratings.png'
    },
    {
        name: 'Okorie Victor',
        class: 'Food Enthusiast',
